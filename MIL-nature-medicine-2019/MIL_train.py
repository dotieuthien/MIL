    ...
    for epoch in range(args.nepochs):
        ...
        if args.val_lib and (epoch+1) % args.test_every == 0:
            ...
            if 1-err >= best_acc:
                ...
                print('Saving\tEpoch: [{}/{}]'.format(epoch+1, args.nepochs))
...
def train(run, loader, model, criterion, optimizer):
    ...
    for i, (input, target) in enumerate(loader):
        ...
        # print('Train\tEpoch: [{}/{}]\tBatch: [{}/{}]'.format(run+1, args.nepochs, i+1, len(loader)))
        optimizer.zero_grad()
        loss.backward()
        optimizer.step()
...
if __name__ == '__main__':
    ...
    # # Load data
    # dataset  = MILdataset('/home/thiendo/Desktop/MIL/data/tumor_slides/tile.pth', trans)
    # dataset.setmode(1)
